package com.rajat.meetingroombooking.service;
...
//	}
	...
	public Optional<Booking> findConflictingBooking(LocalDateTime startTime, LocalDateTime endTime, Long meetingRoomId) {
		List<Booking> conflictingBookings = bookingRepository.findConflictingBookings(startTime, endTime, meetingRoomId);
